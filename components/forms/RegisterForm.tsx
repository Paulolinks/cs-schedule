  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <section className="space-y-6">
          <div className="mb-9 space-y-1">
            <h2 className="sub-header">Equipment Information</h2>
          </div>
        ...
        <section className="space-y-6">
          ...
          <CustomFormField
            ...
            label="Take a photo of your condenser Tag"
            renderSkeleton={(field) => (
              <FormControl>
        ...
        <section className="space-y-6">
          <div className="mb-9 space-y-1">
            <h2 className="sub-header">Human test and Privacy</h2>
          </div>
